...
```json
{
  ...
  "steps": [
    {"stepNo": 1, "stepType": "mcp_tool", "name": "补充 ADDED 新 topic apply 与移动失败目录回滚测试"},
    {"stepNo": 2, "stepType": "mcp_tool", "name": "在 ADDED 创建前纳入 topic 目录事务跟踪"},
    {"stepNo": 3, "stepType": "mcp_tool", "name": "加固目录回滚对既有 topic 的保护"},
